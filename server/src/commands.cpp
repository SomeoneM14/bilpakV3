...
namespace bilpakCommands 
{
    ...
    int dvd() {
        ...
        auto window = sf::RenderWindow(sf::VideoMode(screenWidth, screenHeight), "CMake SFML Project", sf::Style::Fullscreen);
        ...
        sf::Vector2f velocity(5.f*randomMinusOrPlus(), 5.f*randomMinusOrPlus()); // Movement direction
        ...
        while (window.isOpen()) {
            ...
            if (position.y <= 0 || position.y + screenshotSprite.getGlobalBounds().height >= screenHeight) {
